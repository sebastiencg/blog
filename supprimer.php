...
<div class="container mt-3">
    <ul class="nav justify-content-end">
        ...
        <li class="nav-item" style=" background-color: aqua ; border-radius: 20px">
            <a class="nav-link" href="modif.php">supprimer</a>
        </li>
        <li class="nav-item" style=" background-color: aqua ; border-radius: 20px">
...
<div class="post mt-3 container">
    <?php foreach ($reponses as $reponse) : ?>
        <div class="post mt-3">
            <form method="post" action="effacer.php">
                <input type="hidden" name="titre" value="<?= $reponse["titre"] ?>" id="titre">
                <h3><?= $reponse["titre"] ?></h3>
                <button type="submit" class="btn btn-primary" style="background-color: red"> supprimer</button>
            </form>
        </div>
    <?php endforeach; ?>
</div>
